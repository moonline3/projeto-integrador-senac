  ...
  <div class="position-absolute top-50 start-50 translate-middle border-box p-5 btn-outline-primary border rounded-2 bg-white" style="width: 25rem;">
    <h5  class="text-center fs-3 mb-5" >Adicionar Produto</h5>
      <div class="row fs-5">
        ...
        <input placeholder="Batata" class="col" type="text" name="products" id="" style="height: 2rem;">
      </div>
      <div class="row fs-5">
        <p class="col">Preço: <!--Caixa--></p>
        <input placeholder="10$" class="col" type="text" name="price_cents" id="" style="height: 2rem;">
      </div>
      <div class="row fs-5">
        <p class="col">Descrição: <!--Caixa--></p>
        <input placeholder="Muito gostosa" class="col" type="text" name="description" id="" style="height: 2rem;">
      </div>
